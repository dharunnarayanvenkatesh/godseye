"""Provider-neutral tool definitions for the God's Eye agent.
...
TOOL_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        "name": "search_sources",
        "description": (
            "Search the curated investigative-source catalog by topic, entity type, "
            "jurisdiction, access method, or category. Use this before general web search "
            "to select authoritative databases for an investigation."
        ),
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Search terms such as company, sanctions, domain, procurement, or United Kingdom.",
                },
                "category": {
                    "type": "string",
                    "description": "Optional category substring, such as Corporate Registries or Domain Intelligence.",
                },
                "limit": {
                    "type": "integer",
    ...
    {
        "name": "source_details",
        "description": "Get access notes, homepage, cautions, wiki path, and related leads for one catalog source.",
        "parameters": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string",
                    "description": "Exact source name returned by search_sources.",
                },
            },
            "required": ["name"],
            "additionalProperties": False,
