...
CATEGORY_COLORS: dict[str, str] = {
    ...
    "developer-footprints": "bright_blue",
    "domain-dns-intel": "bright_cyan",
    "government-contracts": "yellow",
    "corporate-registries": "cyan",
    "financial": "magenta",
    "identity-intel": "bright_yellow",
    "influence-networks": "red",
    "lobbying": "red",
    "market-financial-data": "magenta",
    "news-web-archives": "blue",
    "nonprofits": "blue",
    "procurement": "yellow",
    "reference-data": "white",
    "regulatory-enforcement": "bright_red",
    "sanctions": "bright_magenta",
    "search-apis": "bright_green",
    "social-identity-intel": "bright_magenta",
    "social-platforms": "blue",
    "threat-intelligence": "bright_red",
    "trade-supply-chain": "yellow",
    "web-technology-intel": "cyan",
    "international": "bright_cyan",
    "infrastructure": "bright_green",
    "investigative-archives": "bright_white",
    "legal-court-records": "bright_blue",
}
