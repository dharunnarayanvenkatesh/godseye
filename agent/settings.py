...
class PersistentSettings:
    ...
    default_model_deepseek: str | None = None
    ...
    def default_model_for_provider(self, provider: str) -> str | None:
        per_provider = {
            ...
            "deepseek": self.default_model_deepseek,
    ...
    def normalized(self) -> "PersistentSettings":
        ...
        return PersistentSettings(
            ...
            default_model_deepseek=(self.default_model_deepseek or "").strip() or None,
    ...
    def to_json(self) -> dict[str, str]:
        ...
        if self.default_model_deepseek:
            payload["default_model_deepseek"] = self.default_model_deepseek
    ...
    def from_json(cls, payload: dict | None) -> "PersistentSettings":
        ...
        return cls(
            ...
            default_model_deepseek=(str(payload.get("default_model_deepseek", "")).strip() or None),
