"""Textual-based TUI for God's Eye with wiki knowledge graph panel.
...
# ---------------------------------------------------------------------------
# God's Eye Textual App
# ---------------------------------------------------------------------------

class GodsEyeApp(App):
    """Textual App for God's Eye with chat pane and wiki graph panel."""
...
def run_textual_app(ctx: ChatContext, startup_info: dict[str, str] | None = None) -> None:
    ...
    app = GodsEyeApp(ctx, startup_info=startup_info)
    app.run()
