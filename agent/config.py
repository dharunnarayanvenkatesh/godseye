...
class AgentConfig:
    ...
    def from_env(cls, workspace: str | Path) -> "AgentConfig":
        ...
        anthropic_api_key = os.getenv("GODSEYE_ANTHROPIC_API_KEY") or os.getenv("ANTHROPIC_API_KEY")
        openrouter_api_key = os.getenv("GODSEYE_OPENROUTER_API_KEY") or os.getenv("OPENROUTER_API_KEY")
        cerebras_api_key = os.getenv("GODSEYE_CEREBRAS_API_KEY") or os.getenv("CEREBRAS_API_KEY")
        deepseek_api_key = os.getenv("GODSEYE_DEEPSEEK_API_KEY") or os.getenv("DEEPSEEK_API_KEY")
        exa_api_key = os.getenv("GODSEYE_EXA_API_KEY") or os.getenv("EXA_API_KEY")
        voyage_api_key = os.getenv("GODSEYE_VOYAGE_API_KEY") or os.getenv("VOYAGE_API_KEY")
        openai_base_url = os.getenv("GODSEYE_OPENAI_BASE_URL") or os.getenv(
            "GODSEYE_BASE_URL",
            "https://api.openai.com/v1",
        )
        return cls(
            workspace=ws,
            provider=os.getenv("GODSEYE_PROVIDER", "auto").strip().lower() or "auto",
            model=os.getenv("GODSEYE_MODEL", "claude-opus-4-6"),
            reasoning_effort=(os.getenv("GODSEYE_REASONING_EFFORT", "high").strip().lower() or None),
            base_url=openai_base_url,
            api_key=openai_api_key,
            openai_base_url=openai_base_url,
            anthropic_base_url=os.getenv("GODSEYE_ANTHROPIC_BASE_URL", "https://api.anthropic.com/v1"),
            openrouter_base_url=os.getenv("GODSEYE_OPENROUTER_BASE_URL", "https://openrouter.ai/api/v1"),
            cerebras_base_url=os.getenv("GODSEYE_CEREBRAS_BASE_URL", "https://api.cerebras.ai/v1"),
            deepseek_base_url=os.getenv("GODSEYE_DEEPSEEK_BASE_URL", "https://api.deepseek.com/v1"),
            ollama_base_url=os.getenv("GODSEYE_OLLAMA_BASE_URL", "http://localhost:11434/v1"),
            exa_base_url=os.getenv("GODSEYE_EXA_BASE_URL", "https://api.exa.ai"),
