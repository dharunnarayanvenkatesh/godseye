...
Global news/event monitoring, full-text metadata, events, and translations.

## Access Methods

- **Primary access**: public APIs and BigQuery dataset
- **Homepage/docs**: https://www.gdeltproject.org/
...
- **Media Cloud**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Event Registry**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Common Crawl**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
