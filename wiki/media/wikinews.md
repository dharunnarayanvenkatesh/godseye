...
Open collaborative news articles and metadata.

## Access Methods

- **Primary access**: public MediaWiki APIs/dumps
- **Homepage/docs**: https://www.wikinews.org/
...
- **Wikimedia APIs**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
