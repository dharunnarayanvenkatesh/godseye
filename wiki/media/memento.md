...
TimeGate protocol for discovering archived versions across web archives.

## Access Methods

- **Primary access**: public protocol/API aggregators
- **Homepage/docs**: https://timetravel.mementoweb.org/
...
- **Internet Archive**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
