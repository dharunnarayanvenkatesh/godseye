...
Wayback Machine snapshots, collections, and media metadata.

## Access Methods

- **Primary access**: public APIs
- **Homepage/docs**: https://archive.org/developers/
...
- **Memento**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
