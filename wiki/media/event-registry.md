...
News article clustering, events, entities, and trends.

## Access Methods

- **Primary access**: API key; free and paid tiers
- **Homepage/docs**: https://eventregistry.org/documentation
...
- **NewsAPI**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
