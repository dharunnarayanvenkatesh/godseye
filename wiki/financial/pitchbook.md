...
Private-market companies, investors, funds, deals, valuations, and executives.

## Access Methods

- **Primary access**: commercial
- **Homepage/docs**: https://pitchbook.com/
...
- **Jurisdiction**: Global private markets
...
- **Crunchbase**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Orbis**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
