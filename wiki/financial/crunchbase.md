...
Company, funding-round, investor, acquisition, and people data.

## Access Methods

- **Primary access**: API/commercial terms
- **Homepage/docs**: https://data.crunchbase.com/docs
...
- **Jurisdiction**: Global startups and investors
