...
Market prices, fundamentals, FX, crypto, and economic indicators.

## Access Methods

- **Primary access**: API key; free and paid tiers
- **Homepage/docs**: https://www.alphavantage.co/documentation/
...
- **Financial Modeling Prep**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
