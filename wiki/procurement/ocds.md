...
Common data model for planning, tender, award, contract, and implementation stages.

## Access Methods

- **Primary access**: open schema and publisher-specific feeds
- **Homepage/docs**: https://standard.open-contracting.org/latest/en/
...
- **OpenTender**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **EU TED**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **World Bank procurement data**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
