...
European procurement data aggregated for market and integrity analysis.

## Access Methods

- **Primary access**: public web search; bulk/API availability varies
- **Homepage/docs**: https://opentender.eu/
