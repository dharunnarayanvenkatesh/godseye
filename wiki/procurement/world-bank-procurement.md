...
World Bank projects, procurement notices, contract awards, and supplier records.

## Access Methods

- **Primary access**: public APIs and downloads
- **Homepage/docs**: https://financesapp.worldbank.org/procurement/
...
- **OpenSanctions**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
...
- https://financesapp.worldbank.org/procurement/
