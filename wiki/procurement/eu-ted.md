...
Tenders Electronic Daily, the EU supplement to the Official Journal for public procurement.

## Access Methods

- **Primary access**: public search, API, and bulk notices
- **Homepage/docs**: https://ted.europa.eu/
...
- **Open Contracting Data Standard**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **EU business registries**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
