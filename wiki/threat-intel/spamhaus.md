...
Spam, botnet, malware, and abuse blocklists and lookups.

## Access Methods

- **Primary access**: public lookups; data/API terms vary
- **Homepage/docs**: https://www.spamhaus.org/
...
- **MXToolbox**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **AbuseIPDB**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **PhishTank**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
