...
Passive DNS, WHOIS, SSL, tracker, and host intelligence from Microsoft Defender TI.

## Access Methods

- **Primary access**: commercial/API
- **Homepage/docs**: https://learn.microsoft.com/en-us/defender/threat-intelligence/
- **Access caution**: Use only with authorized credentials.
...
- **DomainTools**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **SecurityTrails**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **VirusTotal**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
