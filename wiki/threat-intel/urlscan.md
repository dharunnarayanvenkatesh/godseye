...
URL scanning, page metadata, screenshots, requests, certificates, and related indicators.

## Access Methods

- **Primary access**: public search/API; API key for submissions
- **Homepage/docs**: https://urlscan.io/docs/api/
...
- **crt.sh**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **VirusTotal**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **OpenPhish**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
