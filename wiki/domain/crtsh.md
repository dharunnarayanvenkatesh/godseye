...
Certificate Transparency search by domain, certificate, issuer, and identity fields.

## Access Methods

- **Primary access**: public web and query endpoints
- **Homepage/docs**: https://crt.sh/
...
- **Certificate Transparency logs**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Subfinder**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Amass**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
