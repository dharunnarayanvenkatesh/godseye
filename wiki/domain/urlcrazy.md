...
Domain typo, homoglyph, and brand impersonation discovery.

## Access Methods

- **Primary access**: open-source tool
- **Homepage/docs**: https://github.com/urbanadventurer/urlcrazy
...
- **DNSTwist**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
