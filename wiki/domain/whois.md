...
Legacy registration records for domains, IP allocations, and contacts.

## Access Methods

- **Primary access**: public protocol; often rate-limited/redacted
- **Homepage/docs**: https://lookup.icann.org/
...
- **RDAP**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
