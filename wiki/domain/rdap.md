...
Structured successor to WHOIS for domain, IP, ASN, registrar, and contact metadata.

## Access Methods

- **Primary access**: public protocol and registry endpoints
- **Homepage/docs**: https://rdap.org/
...
- **ICANN Lookup**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
