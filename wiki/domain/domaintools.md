...
Domain ownership, historical WHOIS, passive DNS, and risk scoring.

## Access Methods

- **Primary access**: commercial API
- **Homepage/docs**: https://www.domaintools.com/integrations/api/
- **Access caution**: Use only with licensed access.
...
- **WHOIS**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **SecurityTrails**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **RiskIQ PassiveTotal**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
...
- https://www.domaintools.com/integrations/api/
