...
- **Primary access**: open-source tool; data-source API keys optional
- **Homepage/docs**: https://github.com/projectdiscovery/subfinder
...
- **Assetfinder**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
