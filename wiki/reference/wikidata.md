...
Open knowledge graph for identifiers, aliases, organizational relationships, and biographical context.

## Access Methods

- **Primary access**: public SPARQL/API and dumps
- **Homepage/docs**: https://www.wikidata.org/wiki/Wikidata:Data_access
