...
Public or permissioned Discord community monitoring and metadata collection.

## Access Methods

- **Primary access**: platform/API access varies
- **Homepage/docs**: https://discord.com/developers/docs/intro
- **Access caution**: Do not scrape private servers or bypass access controls.
