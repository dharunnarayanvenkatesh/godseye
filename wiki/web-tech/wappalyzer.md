...
Website technology detection and enrichment.

## Access Methods

- **Primary access**: browser extension/API/commercial
- **Homepage/docs**: https://www.wappalyzer.com/
...
- **BuiltWith**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **httpx**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
