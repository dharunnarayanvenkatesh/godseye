# Steam public-profile tools

## Summary

Public Steam profile, vanity URL, friend, and game metadata where visible.

## Access Methods

- **Primary access**: public profile/API where available
- **Homepage/docs**: https://steamcommunity.com/dev
...
- **Sherlock**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Maigret**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **WhatsMyName**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
