...
Username-checking site list and tools.

## Access Methods

- **Primary access**: open-source list/tool
- **Homepage/docs**: https://github.com/WebBreacher/WhatsMyName
...
- **WhatsMyName Web**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
