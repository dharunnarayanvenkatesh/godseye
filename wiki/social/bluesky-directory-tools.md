# Bluesky directory tools

## Summary

Account, DID, handle, and social graph discovery on AT Protocol.

## Access Methods

- **Primary access**: public APIs/firehose
- **Homepage/docs**: https://docs.bsky.app/
...
- **Bluesky firehose**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Mastodon account search**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
