...
Username search and profile collection across many sites.

## Access Methods

- **Primary access**: open-source tool
- **Homepage/docs**: https://github.com/soxoj/maigret
- **Access caution**: Respect platform terms and avoid harassment or doxxing.
...
- **Social Analyzer**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
