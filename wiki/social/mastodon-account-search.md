...
Account and post search across individual Mastodon instances.

## Access Methods

- **Primary access**: public instance APIs
- **Homepage/docs**: https://docs.joinmastodon.org/methods/search/
