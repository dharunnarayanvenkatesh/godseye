...
Username and domain availability checks.

## Access Methods

- **Primary access**: public web/commercial
- **Homepage/docs**: https://namechk.com/
...
- **KnowEm**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
