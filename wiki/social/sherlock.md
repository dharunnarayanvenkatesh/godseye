...
Username search across social sites.

## Access Methods

- **Primary access**: open-source tool
- **Homepage/docs**: https://github.com/sherlock-project/sherlock
...
- **Namechk**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
