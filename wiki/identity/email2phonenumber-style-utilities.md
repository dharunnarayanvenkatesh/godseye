# Email2phonenumber-style utilities

## Summary

Class of utilities that infer phone-number hints from account recovery or public signals.

## Access Methods

- **Primary access**: varies; often fragile/unofficial
- **Homepage/docs**: https://github.com/martinvigo/email2phonenumber
- **Access caution**: High privacy risk; use only with explicit authorization and do not automate against services without permission.
...
- **Holehe**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Epieos**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **GHunt**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
