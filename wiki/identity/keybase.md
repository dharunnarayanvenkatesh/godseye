...
Identity proofs linking usernames, keys, domains, and social accounts.

## Access Methods

- **Primary access**: public web/API
- **Homepage/docs**: https://keybase.io/docs/api/1.0
...
- **PGP key servers**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **GitHub and GitLab APIs**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **Gravatar lookup**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
