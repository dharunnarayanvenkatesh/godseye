...
Breach corpus for account exposure checks and domain monitoring.

## Access Methods

- **Primary access**: API key for breached account checks; k-anonymity password API
- **Homepage/docs**: https://haveibeenpwned.com/API/v3
- **Access caution**: Use only for accounts/domains you are authorized to check.
...
- **Jurisdiction**: Breach-notification corpus
...
- **EmailRep**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
