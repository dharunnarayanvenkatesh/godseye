...
Email discovery and verification for domains and organizations.

## Access Methods

- **Primary access**: API key; free and paid tiers
- **Homepage/docs**: https://hunter.io/api-documentation
...
- **theHarvester**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
