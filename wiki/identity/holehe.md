...
Checks whether an email is associated with public account-signup flows.

## Access Methods

- **Primary access**: open-source tool
- **Homepage/docs**: https://github.com/megadose/holehe
- **Access caution**: Use only for authorized investigations; avoid intrusive enumeration.
