...
Programmable Google search over selected sites or the broader web.

## Access Methods

- **Primary access**: API key and search engine ID
- **Homepage/docs**: https://developers.google.com/custom-search/v1/overview
