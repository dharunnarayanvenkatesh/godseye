...
Bulk UK company snapshot data for large-scale matching.

## Access Methods

- **Primary access**: public bulk downloads
- **Homepage/docs**: https://download.companieshouse.gov.uk/en_output.html
