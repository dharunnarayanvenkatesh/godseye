...
Legal Entity Identifier reference data for registered entities and relationships.

## Access Methods

- **Primary access**: public API and bulk downloads
- **Homepage/docs**: https://www.gleif.org/en/lei-data/gleif-api
