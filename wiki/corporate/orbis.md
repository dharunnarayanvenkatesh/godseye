...
Commercial company reference, ownership, financial, and corporate-family data.

## Access Methods

- **Primary access**: commercial
- **Homepage/docs**: https://www.moodys.com/web/en/us/capabilities/company-reference-data/orbis.html
...
- **PitchBook**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
