...
EU business-register discovery layer and member-state company registries.

## Access Methods

- **Primary access**: mixed national portals; BRIS web search
- **Homepage/docs**: https://e-justice.europa.eu/489/EN/business_registers__search_for_a_company_in_the_eu
