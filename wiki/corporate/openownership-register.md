...
Beneficial ownership data normalized with the Beneficial Ownership Data Standard.

## Access Methods

- **Primary access**: public search and bulk data where available
- **Homepage/docs**: https://register.openownership.org/
...
- **UK Companies House**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
