...
Court opinions, dockets, judges, parties, and legal citations from Free Law Project.

## Access Methods

- **Primary access**: public web/API
- **Homepage/docs**: https://www.courtlistener.com/api/
...
- **PACER**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
