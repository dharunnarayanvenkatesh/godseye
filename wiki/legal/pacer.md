...
Official US federal court docket and filing access.

## Access Methods

- **Primary access**: paid official access
- **Homepage/docs**: https://pacer.uscourts.gov/
- **Access caution**: Paid service; observe court rules, account terms, and privacy limits.
...
- **CourtListener**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
- **RECAP**: join on names, identifiers, domains, addresses, dates, or source-specific IDs where available.
