...
Relationship database for people, organizations, boards, donors, lobbying, and influence networks.

## Access Methods

- **Primary access**: public web/API
- **Homepage/docs**: https://littlesis.org/
