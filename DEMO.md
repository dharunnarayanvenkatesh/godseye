...
### Setup (30 seconds)
*"Let me show you God's Eye. I have three CSV files -- one is a company registry, one is a list of financial transactions, and one is a list of people with their addresses. These could come from any source -- databases, APIs, documents -- but for this demo I'll keep it simple."*
...
### Close (15 seconds)
*"That's God's Eye. From raw files to a structured knowledge graph, entity resolution, visual exploration, AI-powered analysis, and operational action -- all through conversation. Open source, self-hosted, your data stays yours."*
...
The ontology is the difference. ChatGPT can answer questions about data. God's Eye *understands* the domain -- entities, relationships, confidence, provenance -- and that understanding persists, grows, and can be acted upon.
