...
use godseye_core::events::{DeltaEvent, DeltaKind};
use godseye_core::model::openai::OpenAIModel;
use godseye_core::model::anthropic::AnthropicModel;
use godseye_core::model::{BaseModel, Message};
...
async fn test_solve_with_mock_anthropic() {
    use godseye_core::config::AgentConfig;
    use godseye_core::engine::{solve, SolveEmitter};
    use godseye_core::events::StepEvent;
