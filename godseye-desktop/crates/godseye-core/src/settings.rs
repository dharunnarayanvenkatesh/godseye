...
pub struct PersistentSettings {
    ...
    pub default_model_deepseek: Option<String>,
...
impl PersistentSettings {
    ...
    pub fn default_model_for_provider(&self, provider: &str) -> Option<&str> {
        let specific = match provider {
            ...
            "deepseek" => self.default_model_deepseek.as_deref(),
    ...
    pub fn normalized(&self) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            default_model_deepseek: trim_opt(&self.default_model_deepseek),
    ...
    pub fn to_json(&self) -> HashMap<String, String> {
        ...
        add!(default_model_deepseek, "default_model_deepseek");
    ...
    pub fn from_json(payload: &serde_json::Value) -> Result<Self, String> {
        ...
        let settings = Self {
            ...
            default_model_deepseek: get_str(obj, "default_model_deepseek"),
...
/// Persistent settings store at `{workspace}/.godseye/settings.json`.
...
mod tests {
    ...
    fn test_settings_store_save_load() {
        ...
        let store = SettingsStore::new(dir.path(), ".godseye");
        let settings = PersistentSettings {
