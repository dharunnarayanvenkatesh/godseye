...
impl CredentialBundle {
    ...
    pub fn to_json(&self) -> HashMap<String, String> {
        ...
        add!(deepseek_api_key, "deepseek_api_key");
    ...
    pub fn from_json(payload: &HashMap<String, serde_json::Value>) -> Self {
        ...
        Self {
            ...
            deepseek_api_key: get_str(payload, "deepseek_api_key"),
...
pub fn parse_env_file(path: &Path) -> CredentialBundle {
    ...
    CredentialBundle {
        openai_api_key: get_key(&env_map, "OPENAI_API_KEY", "GODSEYE_OPENAI_API_KEY"),
        ...
        openrouter_api_key: get_key(
            &env_map,
            "OPENROUTER_API_KEY",
            "GODSEYE_OPENROUTER_API_KEY",
        ),
        cerebras_api_key: get_key(
            &env_map,
            "CEREBRAS_API_KEY",
            "GODSEYE_CEREBRAS_API_KEY",
        ),
        deepseek_api_key: get_key(
            &env_map,
            "DEEPSEEK_API_KEY",
            "GODSEYE_DEEPSEEK_API_KEY",
        ),
        exa_api_key: get_key(&env_map, "EXA_API_KEY", "GODSEYE_EXA_API_KEY"),
        voyage_api_key: get_key(&env_map, "VOYAGE_API_KEY", "GODSEYE_VOYAGE_API_KEY"),
    }
}
...
pub fn credentials_from_env() -> CredentialBundle {
    ...
    CredentialBundle {
        openai_api_key: env_key("GODSEYE_OPENAI_API_KEY", "OPENAI_API_KEY"),
        anthropic_api_key: env_key("GODSEYE_ANTHROPIC_API_KEY", "ANTHROPIC_API_KEY"),
        openrouter_api_key: env_key("GODSEYE_OPENROUTER_API_KEY", "OPENROUTER_API_KEY"),
        cerebras_api_key: env_key("GODSEYE_CEREBRAS_API_KEY", "CEREBRAS_API_KEY"),
        deepseek_api_key: env_key("GODSEYE_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        exa_api_key: env_key("GODSEYE_EXA_API_KEY", "EXA_API_KEY"),
        voyage_api_key: env_key("GODSEYE_VOYAGE_API_KEY", "VOYAGE_API_KEY"),
    }
}
...
/// Workspace-level credential store at `{workspace}/.godseye/credentials.json`.
...
"#,
        ...
        assert_eq!(bundle.deepseek_api_key, Some("ds-key".into()));
    ...
    fn test_credential_store_save_load() {
        let dir = tempfile::tempdir().unwrap();
        let store = CredentialStore::new(dir.path(), ".godseye");
        let bundle = CredentialBundle {
