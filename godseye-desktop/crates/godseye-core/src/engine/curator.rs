...
/// and writes to `.godseye/wiki/` using a restricted tool set.
...
Your ONLY job is to update the wiki at .godseye/wiki/ based on the main agent's latest step.

== RULES ==
1. You may ONLY modify files under .godseye/wiki/
2. Read .godseye/wiki/index.md first to understand existing entries
...
5. Update .godseye/wiki/index.md to link any new entries in the correct category table
...
9. Never modify files outside .godseye/wiki/
