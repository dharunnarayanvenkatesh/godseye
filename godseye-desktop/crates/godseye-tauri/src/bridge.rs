...
use godseye_core::engine::SolveEmitter;
use godseye_core::events::{CompleteEvent, CuratorUpdateEvent, DeltaEvent, DeltaKind, ErrorEvent, StepEvent, TraceEvent};
use godseye_core::session::replay::{ReplayEntry, ReplayLogger, StepToolCallEntry};
...
mod tests {
    use super::*;
    use godseye_core::engine::demo_solve;
    use godseye_core::session::replay::ReplayLogger;
